...
class SuperImportantThread extends Thread {
    ...
    public void TeilA() {
    	Sound.playTone(Tones.F4.gib(), Durations.PunktierteGanze.gib());
    	Sound.playTone(Tones.G4.gib(), Durations.Achtel.gib());
    	Sound.playTone(Tones.A4.gib(), Durations.Ganze.gib());
    	Sound.playTone(Tones.G4.gib(), Durations.Ganze.gib());
    	Sound.playTone(Tones.B4f.gib(), Durations.Ganze.gib());
    	Sound.playTone(Tones.A4.gib(), Durations.Ganze.gib());
    	Sound.playTone(Tones.G4.gib(), Durations.Achtel.gib());
    	Sound.playTone(Tones.E4.gib(), Durations.Achtel.gib());
    	Sound.playTone(Tones.F4.gib(), Durations.Ganze.gib());
    	
    	Sound.playTone(Tones.D5.gib(), Durations.Ganze.gib());
    	Sound.playTone(Tones.C5.gib(), Durations.Ganze.gib());
    	Sound.playTone(Tones.B4f.gib(), Durations.Ganze.gib());
    	Sound.playTone(Tones.A4.gib(), Durations.Ganze.gib());
    	Sound.playTone(Tones.G4.gib(), Durations.Ganze.gib());
    ...
    public void TeilB() {
    	...
    	Sound.playTone(Tones.G4.gib(), Durations.Achtel.gib());
    	Sound.playTone(Tones.E4.gib(), Durations.Achtel.gib());
    	Sound.playTone(Tones.C4.gib(), Durations.Ganze.gib());
    	...
    	Sound.playTone(Tones.C5.gib(), Durations.Ganze.gib());
    	Sound.playTone(Tones.B4f.gib(), Durations.Ganze.gib());
    	Sound.playTone(Tones.A4.gib(), Durations.PunktierteGanze.gib());
    	Sound.playTone(Tones.A4.gib(), Durations.Achtel.gib());
    	Sound.playTone(Tones.B4.gib(), Durations.Ganze.gib());
    	Sound.playTone(Tones.B4.gib(), Durations.Achtel.gib());
    	Sound.playTone(Tones.C5.gib(), Durations.Achtel.gib());
    	Sound.playTone(Tones.C5.gib(), Durations.Doppelte.gib());
    	
    	Sound.playTone(Tones.F5.gib(), Durations.PunktierteGanze.gib());
    	Sound.playTone(Tones.E5.gib(), Durations.Achtel.gib());
    	Sound.playTone(Tones.E5.gib(), Durations.Achtel.gib());
    	Sound.playTone(Tones.D5.gib(), Durations.Achtel.gib());
    	Sound.playTone(Tones.C5.gib(), Durations.Ganze.gib());
    	
    	Sound.playTone(Tones.E5.gib(), Durations.PunktierteGanze.gib());
    	Sound.playTone(Tones.D5.gib(), Durations.Achtel.gib());
    	Sound.playTone(Tones.D5.gib(), Durations.Achtel.gib());
    	Sound.playTone(Tones.C5.gib(), Durations.Achtel.gib());
    	Sound.playTone(Tones.B4.gib(), Durations.Ganze.gib());
    	...
    	Sound.playTone(Tones.B4f.gib(), Durations.Achtel.gib());
    	Sound.playTone(Tones.G4.gib(), Durations.Achtel.gib());
    	Sound.playTone(Tones.F4.gib(), Durations.Doppelte.gib());
    }
}
